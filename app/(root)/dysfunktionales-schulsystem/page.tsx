                ...
                <div className="innerBox grid grid-cols-1 xl:grid-cols-2  mt-4 p-0">
                    <div className={" p-4"}>
                        ...
                        <p>Schule hat in Deutschland drei Funktionen: Aufbewahrung, Auslese und Bildung. Seit der
                            ...
                            Motto - Hauptsache der Laden läuft, Hauptsache, die Kinder sind in der Schule versorgt - an
                            erster Stelle. Bildungsqualität muss zurückstehen. Nicht nur PISA Studien belegen, dass
                            unser Schulsystem zu viele VerliererInnen produziert und dem Wohlergehen der anvertrauten
                            Kinder und Jugendlichen zuwiderläuft. Die frühe Aufteilung der Schüler nach der 4. Klasse in
                            höhere und nicht so hohe Bildungsgänge ist international eher einzigartig. In der
                            Fachliteratur gibt es dazu mehrere Kilometer an Veröffentlichungen, die alle in dieselbe
                            Richtung weisen: Diese Selektion, bereits in den Grundschulen, macht den Schulalltag für
                            viele zu einer angstbelasteten Veranstaltung und vergiftet die Atmosphäre an deutschen
                            Regel-Schulen. „Die Hauptschwäche des deutschen Schulsystems ist, dass es die Schulen aus
                            der Verantwortung entlässt, sich um schwierige Schüler zu kümmern. Kinder mit
                            Lernschwierigkeiten werden zu schwierigen, störenden und schließlich gestörten Kindern
                            gemacht. Das ist in dem Ausmaß beispiellos im Vergleich zu allen anderen von Pisa
                            untersuchten Ländern,“ (Reinhard Kahl). Akademiker sind fälschlicherweise immer noch die
                            Leitfiguren des Konzepts der Wissensgesellschaft, das ergibt einen hohen Druck für eine
                    ...
                    <div className={"bg-[color:var(--color-primary)] p-4"}>
                        ...
                        <p>Schule wird in historischer Gewohnheit von oben herab hierarchisch strukturiert und mit
                            ...
                            ein Zimmer und eine Lehrkraft, die im 45 min Takt wechselnd, anwesend ist. Tafel und Schwamm
                            dazu. Stundenplan, Hefte und Bücher. Neuerdings auch digitale Tafeln, Handys oder Tablets.
                    ...
                    <div className={"bg-[color:var(--color-primary)] p-4"}>
                        ...
                        <p>Unser Land lässt seit Jahrzehnten eine genügende Personalplanung vermissen. ErstklässlerInnen
                            ...
                            zu Schuljahresbeginn seit langem zum Alltag. Unsere Schulleitungen sind durch
                            Organisationsarbeit zugeschüttet und irgendwann einfach nur noch froh, wenn sie über die
                            Runden kommen.... Hilferufe werden ignoriert. Viele Lehrkräfte gleichen seit Jahrzehnten
                            aus, was an strukturellen Defiziten krankt. Manche enden im burn-out, andere retten sich in
                            Dienst nach Vorschrift. Schule und der Lehrberuf bedeuten in der Realität: Arbeit ohne Ende,
                            auf allen Ebenen präsent sein (auf Kinderebene, Themen-, Material-, Organisations-,
                            Kooperations-, Elternebene und Bewertungsverantwortung…) und dabei zu versuchen dem
                            einzelnen Kind gerecht zu werden. Es sind immer wieder Konflikte zu lösen, oft unter
                            unmöglichen Bedingungen. Eine Einzellehrkraft, die stundenplanmäßig schon wieder in eine
                            andere Klasse hetzen muss, hat weder die Zeit, noch die Nerven kindgerecht auf Probleme
                            einzugehen. Die Folgen? Es fehlt an echter Bildungsqualität und wir verlieren stetig neue
                            Generationen an Kindern. Jedes Kind kommt außerdem mit unglaublichen individuellen Stärken
                            zur Welt. Welche Verschaltungsmuster im Gehirn aber stabilisiert oder verworfen werden,
                            entscheidet sich über die Beziehungen zu anderen Menschen. Wir Menschen haben eine
                            Sonderstellung in der Natur, nur wir können uns eine Vorstellung machen, wie wir leben
                            wollen. Ein kleines Kind braucht Erwachsene, die ihm helfen, wie das Leben geht. Wir sind
                            alle Suchende. Die wichtigste Erkenntnis der Hirnforschung lautet: Das menschliche Gehirn
                            ist lebenslang weitaus formbarer in seiner inneren Struktur und Organisation, als bisher
                            gedacht. Im kindlichen Gehirn wird viel mehr an Vernetzungspotenzial zwischen den
                            Nervenzellen bereitgestellt, als jemals genutzt werden kann. Netzwerke, die aber nicht
                            gebraucht werden, werden wieder abgebaut. Unser Gehirn ist dabei wie ein wachsender Baum,
                            der sich im Wachsen strukturiert. Es ist also eine Baustelle und entwickelt sich in einem
                            nutzungsabhängigem Prozess. In der Auseinandersetzung mit der Welt finden im Gehirn
                            neuronale Bahnungsprozesse statt. Ist ein Problem gut gelöst, wird das Belohnungssystem in
                            unserem Gehirn aktiviert und es werden Botenstoffe freigesetzt. Diese
                            Nerven-Wachstumshormone wirken wie Dünger: die Netzwerke, die ein Kind grade zum Lernen
                            benutzt hat um das Schwierige hinzubringen, werden dadurch immer stärker z.B.beim Fahrrad
                            fahren. Diese Bahnungsprozesse gelingen besonders unter emotionaler Beteiligung. Wo man mit
                    ...
                    <div className={"p-4"}>
                        ...
                        <p>Natürlich haben wir ziemlich gute Werte und hehre Bildungsziele - dem gesellschaftlichen
                            ...
                            Inklusion leisten ..... Es gibt unzählige neue Programme, Medien, Fortbildungen über neue
                            Lernformen oder Schwerpunkte, die Lehrkräfte umsetzen sollen und natürlich auch wollen, ...
                            Nur: In laufendem Stress-Betrieb bleibt vieles auf der Strecke. Auch die Schulentwicklung
                            findet nicht systematisch statt, sondern bleibt abhängig von besonders engagierten
                            Schulleitungen und Kollegien. Die Unterstützung der Schulverwaltung oder der Landespolitik
                            bleibt insgesamt ungenügend. Die notwendige Transformation gelingt nur im Glücksfall und an
