...
const Page = () => {
  const infoCardContents = [
    '<strong class="text-accent">Jahrgangsgemischte Klassen 1-10.</strong>  Alle Schülerinnen und Schüler lernen vom 1. Schuljahr bis zu ihrem bestmöglichen Schulabschluss in einer Schule. Keine Noten bis einschließlich Klasse 8,  Rückmeldungen in Berichtszeugnissen.',
    '<strong class="text-accent">Gebundener verpflichtender Ganztag</strong> für alle Kinder bis zum 10. Schuljahr. Verpflichtendes Mittagessen.',
    '<strong class="text-accent">Jedes! Kind des nahen Umfeldes wird aufgenommen.</strong> 20-40% davon, also mehr als 100 von 550 SchülerInnen haben offiziell sonderpädagogischen Unterstützungsbedarf.',
    'Grundlage ist die <strong class="text-accent">inklusive interkulturelle, behindertengerechte, jungen- und mädchengerechte Erziehung</strong>. Es gibt über Jahrzehnte entwickelte, friedenstiftende Traditionen interkultureller und interreligiöser gemeinsamer Feiern. Damit wird die angebahnte vertrauensvolle Zusammenarbeit mit den Familien aus 50 Nationen kontinuierlich fortgesetzt. Sie wirken erfolgreich diskriminierenden Strukturen entgegen und wertschätzen die Vielfalt.',
    '<strong class="text-accent">Das Konzept - Länger gemeinsam:</strong> Die Schülerinnen und Schüler bleiben von Klasse 1 bis 10 an der selben Schule, es gibt also keinen Wechsel mehr von der Grundschule zur weiterführenden Schule. Die Ergebnisse zeigen, dass die Lernfortschritte der Kinder alle Erwartungen übertreffen.',
    '<strong class="text-accent">Jahrgangsgemischtes, inklusives Lernen, um mehr effektive Lernzeit</strong> für die Kinder zu gewinnen. Die Klassen sind altersgemischt: Jg 1-3, 4-6, 7-9. Diese Vielfalt ermöglicht Peer-learning, Peer-Tutoring (von und miteinander lernen) und mehrperspektivisches Lernen. Die Potentiale der SchülerInnen entwickeln sich, weil dafür gesorgt wird, dass sich die Lernenden gegenseitig anregen und unterstützen; kurz, weil sie miteinander und von einander lernen können.',
    'Ein verlässlich, auf Jahre hinaus angelegtes, klasseneigenes <strong class="text-accent">multiprofessionelles Verantwortungsteam</strong> (Lehrkräfte/ Sonderpädagogen, Erzieher:in, Integationshelfer:in, Studierende über Honorarstellen…) ermöglicht systematische und einheitliche Förderung aller Kinder. Die Klassenlehrer:innen leiten ihre Teams und sind verantwortliche Hauptansprechpartner:innen. Jeden Montag findet die Teamsitzung statt. Alle  6-8 Wochen gibt es Supervision und 2 x pro Jahr einen Teamtag. Die Vertretungsregelung erledigt das klasseneigene Team für sich, dadurch entsteht Entlastung für die Schulleitung.',
    '<strong class="text-accent">Grundhaltung:</strong> Die festen Pädagogenteams sind entschlossen, keinen Schüler aufzugeben, sowie allen das Denken zu lehren. Sie sorgen für Lernzuwachsmöglichkeiten bei allen Schüler:innen. „Wir sind alle dazu da, das Lernen jedes einzelnen Kindes herauszufordern und die Kinder bei diesem Prozess zu unterstützen, ihnen zu helfen und sie verlässlich zu begleiten. Dafür müssen wir in Beziehung treten.“ (S.40 Teambuch Inklusion).',
    '<strong class="text-accent">Vorteil der Mehrperspektivität:</strong> „Die Teammitglieder stehen täglich in der Beziehung zu den Lernenden und beobachten die individuellen, entwicklungslogischen Zugänge jedes Einzelnen und können unmittelbar reagieren. Dabei entstehen vielfältige spezifische Sichtweisen auf jedes Kind. Kritische Situationen und stoffliche Hürden können aus verschiedenen Perspektiven beleuchtet und Hilfen individuell abgestimmt werden. Fehlentscheidungen sind weniger wahrscheinlich als bei Lehrkräften, die als Einzelkämpfer arbeiten.“ (S.174 Teambuch Inklusion)',
    '<strong class="text-accent">Jede Klasse hat zwei Räume</strong> - dafür sind viele Fachräume weggefallen und Mittagessen gibt es in den Klassenräumen der Jahrgänge 1-3, ansonsten in der Mensa.',
    'Die PRIMUS Schule - Berg Fidel - Geist erfüllt die Ansprüche der Stundentafeln der Grundschule und der integrativen Sekundarschule in NRW. In den besonderen Lernformen und Erfahrungsfeldern wie z.B. Projekt, Werkstatt und Freie Arbeit oder Freien Forscher Clubs werden sie umgesetzt. <strong class="text-accent">Lernen in Gemeinschaft</strong> an selbstgewählten Sachthemen fördert den eigenen Antrieb, das Methodenlernen, die Selbständigkeit und die Erfahrung von Selbstwirksamkeit.',
    '<strong class="text-accent">Lernen mit Begleitung:</strong> Die Leistungsanforderungen werden so formuliert und strukturiert, dass jeder Schüler die für sein Leistungsniveau passenden Aufgaben (mit Unterstützung) finden und erfolgreich bearbeiten kann… Drei wichtige Fragen beschäftigen die Schüler dabei: Was habe ich schon geschafft?, Wo stehe ich? und Was sind meine nächsten Schritte?',
    'Für den Lernfortschritt ist es immer wichtig, dass die Anforderungen kontinuierlich wachsen und passend an den Lernvoraussetzungen anknüpfen. Dafür braucht es eine <strong class="text-accent">pädagogische Beziehung</strong>, die von Ermutigung und solidarischer Begleitung geprägt ist (Prengel). Auch John Hattie fordert die Koordinierung der pädagogischen Arbeit im Klassenzimmer. Denn: Wechselt die Bezugsperson häufig, so fehlt die beständige Auseinandersetzung an den Herausforderungen, den challenging learning intentions (S.172-3 Teambuch Inklusion).',
    '<strong class="text-accent">Feedback- und Fehlerkultur:</strong> Kooperatives und kommunikatives Lernen führt zu besseren Schülerleistungen (S.110 Teambuch Inklusion). Tragende und entspannte, freudige Beziehungen innerhalb der Klasse bei der freien Arbeit sind das Fundament für eine eigene Entwicklung (S.107 Teambuch Inklusion).',
    '<strong class="text-accent">Klassenrat und Schüler:innenparlament:</strong> In jeder Klasse bis zum Schulabschluss gibt es jede Woche eine Stunde innovativen Klassenrat. Hier bearbeiten die Kinder existenzielle Themen, meistern Peer-Konflikte und entwickeln sich zu selbstbewussten Persönlichkeiten. Im realen Lebenszusammenhang wird Verantwortung gelernt. „Wir glauben an unsere Schüler:innen, dass sie ihre Dinge mit Unterstützung selbst regeln werden.“ Mit diesem Ansatz eröffnet sich ein Schulalltag, der Kinder ganzheitlich stärkt und das Gemeinschaftsgefühl nachhaltig fördert. (siehe Buch "Klassenrat", Reinhard Stähling)',
  ];
