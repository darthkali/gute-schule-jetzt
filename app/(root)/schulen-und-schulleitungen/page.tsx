    ...
    <section>
      <div className={'innerBox'}>
        ...
        <p>
          ...
          wie ein strukturierter Wandel zu einer neuen Lernkultur in den Schulen
          gelingen kann. Auf dieser Webseite finden Sie:
          <br />
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            "Neue Lernkultur - Jetzt!" mit Start am Montag, den 08. Dezember
            2026, die mit 10000 digitalen Unterschriften die politische Kraft
            für spürbaren Fortschritt entwickeln soll. Bitte teilen und im
            Kollegium bekannt machen.
          </li>
        </ul>
        ...
        >
          ...
          <div>
            ...
            <p>
              <TextLinks href={'https://schule-im-aufbruch.de'}>
                Schule-im-Aufbruch
              </TextLinks>{' '}
          ...
          <div>
            ...
            Siehe auch: Startchancen-Programm:
            <ul>
              <li>
                <TextLinks
                  href={
          ...
          <div>
            ...
            <p>
              ...
              <TextLinks href={'https://frei-day.org/'}>FREI DAY</TextLinks>
              ...
              <TextLinks href={'https://17ziele.de/'}>
              ...
              <TextLinks href={'https://frei-day.org/das-buch'}>
                FREI DAY
              </TextLinks>
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              <TextLinks newTab={false} href={'/loesungen'}>
                ASW
              </TextLinks>{' '}
              vor.
            </p>
