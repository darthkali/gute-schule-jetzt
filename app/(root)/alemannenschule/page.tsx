      ...
      <section>
        <div className='innerBox grid grid-cols-1 lg:grid-cols-4 mt-4'>
          <div className={'col-span-3'}>
            ...
            <p>
              Zur Schule gehen ohne Angst und Stress, dafür mit
              vielEigenmotivation, Lernerfolg und Freude? In der
              vielfachausgezeichneten Alemannenschule in Baden-Württemberg ist
              das seitJahren bereits gelebte Realität. Dass Schule auch ohne
              klassischenUnterricht, ja sogar ohne Klassenzimmer, funktioniert,
              hat derSchulleiter Stefan Ruppaner und sein Team inzwischen
              ausreichendbewiesen. 2010 war die ASW noch eine von Schließung
              bedrohteHauptschule. Heute ist sie anerkannte „Zukunftsschule“,
              die unteranderem mit dem Deutschen Schulpreis 2019 ausgezeichnet
              wurde.Die ASW verzichtet auf Frontalunterricht, feste
              Prüfungstermine undJahrgangsklassen. Stattdessen leben Kinder und
              Lehrkräftegegenseitige Wertschätzung, Kreativität, Freiheit und
              moderneUnterrichtsmethoden, losgelöst vom gängigen Schulmodell.
              DieAlemannenschule gilt heute deutschlandweit auch als
              Vorzeigeschule fürdigitale Transformation. Etwa 800 Schüler:innen
              von der 1. Klasse biszum Abitur organisieren hier ihr Lernen
              selbstbestimmt. 2022 wurdeerste Abitur an der Schule mit einem
              Durchschnitt von 1,7 abgelegt. DieHälfte dieser Kinder hatten in
              der 5. Klasse keine Empfehlung für dasGymnasium. Zum Vergleich: in
              BW lag der Abitur-Durchschnittzeitgleich bei 2,17. Auch bei
              Vergleichsarbeiten der 8.Klasse schneidetdie Alemannenschule
