        ...
        <div>
            ...
            <section className={"bg-[color:var(--color-secondary)] text-[color:var(--color-neutral)]"}>
                <div className={"innerBox"}>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mt-4 py-4">
                        <div className="xl:col-span-2 pt-0 ">
                        ...
                        <div className="relative w-full h-100">
                            <Image
                                src={"/images/artificial-intelligence-3382521_1920.jpg"}
                                alt={"Bild"}
                                fill
            ...
            <section>
                <div className={"innerBox"}>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mt-4 py-4">
                        <div className="relative w-full h-100">
                            <Image
                                src={"/images/classroom-1660223_1920.jpg"}
                                alt={"Bild"}
                                fill
                                className="object-cover"
                            />
            ...
            <section className={"bg-[color:var(--color-secondary)] text-[color:var(--color-neutral)]"}>
                <div className={"innerBox"}>
                    ...
                    <p>Schule, als stark machender Lebens-und Lernort, gibt Kindernund Jugendlichen das, was sie aus entwicklungspsychologischerSicht brauchen, ermöglicht Lernen, wie es aus neurobiologischerSicht nachhaltig ist und bereitet Schülerinnen und Schüler auf einLeben in der Gesellschaft vor, wie diese sich heute zeigt und inZukunft abzeichnet.Die neurobiologischen Forschungen lassen die Notwendigkeiterkennen, eine liebevolle Beziehungskultur zu entwickeln, in dervon Anfang an das Gefühl entsteht, angenommen zu sein, und inder die Menschen eingeladen sind, sich für die Welt zu öffnen.Wenn wir uns fragen, wie Lernen geschieht, müssen wir dasDogma aufgeben, das Lernen nur von der Lehrkraft zum Kindfunktioniert! Kinder lernen eigenmotiviert, Kinder lernenvoneinander und in Gemeinschaft.Ein Schulkind hat zwei wesentliche Grundbedürfnisse:• dazugehören zu wollen (Verbundenheit)• sich als gestaltendes Subjekt einbringen zu können(Autonomie)Grundlegende Gelingensbedingungen für eine kindgerechteEntwicklung und Voraussetzung für effektives Lernen in unserenSchulen sind daher:1. dass sich Kinder und Jugendliche im eigenen Lebensund Lernumfeld gesehen, zugehörig und verbundenfühlen2. dass Kinder in Berührung kommen mit dem, was sielebendig macht: Sinnlichkeit, Entdecker- undGestaltungsfreude, Talente entfalten…3. dass Kinder und Jugendliche vielfältige Möglichkeitenbekommen, ihr Gehirn auf komplexe Weise zu nutzen!Kinder brauchen echte Aufgaben, Anstrengung schadetihnen dabei nicht, aber sie brauchen den Erfolg und dieErfahrung der Selbstwirksamkeit.Dann werden Kinder Konstrukteur ihres eigenen Bildungsprozessesund erleben ein wahnsinnig schönes Gefühl, ein subjekthaftes Gefühl:Ich bin einfach da, werde bedingungslos geliebt und kriege genugGelegenheiten Entdecker zu sein.„Es geht also nicht darum Fässer zu füllen, sondern Fackeln zuentzünden“ (den Geist zu entzünden, der die Kulturgüter hervorbringt).</p>

                    <h2>Neue Lernkultur, die gekennzeichnet ist von Ermutigung, Sinnhaftigkeit und Feedback-Kultur Neue Lernformate: Lernen vielfältig begleiten, statt Unterricht durchführen, selbstreguliertes und sinnorientiertes Lernen in Projekten, Lernen in Gemeinschaft</h2>

                    <p>Primarschulen:- Die Kinder und ihre Bildungsbiographien stehen anerster Stelle!- Integration, Inklusion und Vielfalt werden gelebt.Wirksame Rahmenbedingungen, wie längeresgemeinsames Lernen oder eine veränderteLehrerbildung, werden dafür Stück für Stückeingerichtet.- Die neue Schule ist eine Teamschule mit einer neuenLernkultur, die gekennzeichnet ist von Ermutigung,Sinnhaftigkeit, Gemeinschaft und Feedback-Kultur.- Dieser Ansatz kennt keine passiven Partner mehr inder Bildung. Das Kind bleibt aktiver Konstrukteurseiner eigenen Biographie. Um Bildungsprozesseerfolgreich gestalten zu können, müssen dieseangemessen moderiert werden. Dazu muss vor allemeine Gruppenatmosphäre mit positiver FehlerKultur geschaffen werden, die diese Prozesserückhaltlos unterstützt.- Deswegen bekommt jede Grundschulklasse einverlässliches Verantwortungsteam. Kein Kind wirdalleingelassen, alle Teamkräfte gestalten undverantworten die Bildungsentwicklung gemeinsam.Praxisbeispiel: Primusschule Münster Berg Fidel</p>

                    <p>rimarschulen:- Die Kinder und ihre Bildungsbiographien stehen anerster Stelle!- Integration, Inklusion und Vielfalt werden gelebt.Wirksame Rahmenbedingungen, wie längeresgemeinsames Lernen oder eine veränderteLehrerbildung, werden dafür Stück für Stückeingerichtet.- Die neue Schule ist eine Teamschule mit einer neuenLernkultur, die gekennzeichnet ist von Ermutigung,Sinnhaftigkeit, Gemeinschaft und Feedback-Kultur.- Dieser Ansatz kennt keine passiven Partner mehr inder Bildung. Das Kind bleibt aktiver Konstrukteurseiner eigenen Biographie. Um Bildungsprozesseerfolgreich gestalten zu können, müssen dieseangemessen moderiert werden. Dazu muss vor allemeine Gruppenatmosphäre mit positiver FehlerKultur geschaffen werden, die diese Prozesserückhaltlos unterstützt.- Deswegen bekommt jede Grundschulklasse einverlässliches Verantwortungsteam. Kein Kind wirdalleingelassen, alle Teamkräfte gestalten undverantworten die Bildungsentwicklung gemeinsam.Praxisbeispiel: Primusschule Münster Berg Fidel</p>

                    <h2>Gesellschaft zusammenbringen, statt spalten Weg von Selektionsanstalten zu integrativen,kindgerechten Schulen als Chancenorte</h2>

<p>
                    Zu denken geben sollte, dass die in Deutschlandpraktizierte frühe Sortierung auf hierarchischabgestufte Schularten der Sekundarstufe Iinternational unüblich ist. https://deutschesschulportal.de/expertenstimmen/pisa-2018-bildungsgerechtigkeit-tritt-auf-der-stelle/Leben bedeutet Vielfalt. IndividuellePersönlichkeitsentwicklung, Integration, Inklusion undDemokratie sind notwendige Grundlagen für einelebenstüchtige Gesellschaft. Das erfordert eineTransformation der Schulen vom Ort des Lehrens zumOrt des inklusiven und kooperativen Lernens.Dazu ist an vorderster Stelle eine Haltung zu priorisieren:Grundlegende Bildung für alle Kinder zu Werten wie gelebterVielfalt, Mitgefühl und Toleranz!Dafür sind die Rahmenbedingungen zu schaffen: So dassunsere Grundschulen die kleinen Kinder aufnehmen, siewillkommen heißen, kleine Gemeinschaften mit ihnen aufbauenkönnen, in denen sie ihr Potential in Ruhe und gut unterstütztentfalten können. In denen sie lernen, für sich einzustehen,neugierig mit der Vielfalt in der Welt umzugehen, Lernlust undAusdauer zu entwickeln, von einander zu lernen, Konfliktegemeinsam aus der Welt zu schaffen und etwas für dieGemeinschaft beizutragen. Menschliches Glück wird von unserenBeziehungen mit anderen angetrieben. Teamarbeit und Raumfür Kreativität sind dafür Schlüsselwerkzeuge.
                    </p><p>
                    Schulen brauchen dazu Gestaltungshoheit und siemüssen Zeit haben - für Beziehung und Kooperation!Schulen können so zu Kraftorten werden, die für alleKinder einstehen und in einem lebendigen Bündnis mitEltern und Ortschaft wirken.Prof. Gerald Hüther erklärt: “Zukunftsfähige menschlicheGemeinschaften funktionieren ähnlich wie unser Gehirn",sagt Prof. Gerald Hüther, "Das wächst nicht, indem esimmer größer wird, bis uns irgendwann der Schädelplatzt."Es wächst stattdessen durch eine fortwährendeIntensivierung der Beziehungen zwischen denNervenzellen, also durch Verstärkung seiner Vernetzung.Dieses Wachstumsmodell übertragen auf menschlicheGemeinschaften oder Kommunen heißt: mehrBegegnung, mehr Austausch, mehr Vernetzung, mehrGemeinsinn, mehr Kreativität und mehrInnovationsgeist.Das Zeitalter der Einzelkämpfer, in dem wir allzu oftKonkurrenten sind und den anderen als Objekt behandeln,geht zu Ende. Um zu einem zufriedenstellendenMiteinander zu gelangen, müssen wir einZusammenleben erlernen, in dem wir uns gegenseitig alseinzigartige Subjekte wahrnehmen und uns so begegnen,dass in gemeinschaftlichem Miteinander die Fülle unsererFähigkeiten sich nicht nur addieren, sondern potenzierenkann.
                </p><p>
                    Prof. John Hattie, einer der renommiertestenBildungsforscher weltweit, erhebt im Dezember 2024schwere Vorwürfe gegen das deutsche Schulsystem:„Dasungerechteste Schulsystem, das ich kenne!“und hältBildungsreformen in Deutschland für dringend geboten.Er kritisiert die frühe Aufteilung der Kinder inverschiedene Schulformen als ineffizient undgesellschaftlich schädlich. Stattdessen plädiert er fürlängeres gemeinsames Lernen, mehrChancengerechtigkeit und eine neue Sichtweise aufdie Rolle der Lehrkräfte. Seine Botschaft: Ohne mutigeReformen bleibt das deutsche Bildungssystem in derSackgasse.http://www.laenger-gemeinsam-lernen-bw.de/Die UN-Behindertenrechtskonvention fordert einestrukturelle Transformation des deutschenBildungssystems (Ref. [1], Ziff. 40) Eine aktuelle Studieund der aktuelle Menschenrechtsbericht sieht BadenWürttemberg bei der Umsetzung von Artikel 24 imVergleich der Bundesländer noch als Schlusslicht(Stellungnahme der AG „Bildung und Kultur“ des LAPBeteiligungsprozess 08.09.2023 zur Umsetzung der UNBRK).Forscher bestätigen das: Länger zusammen lernensorgt für mehr Fairness.

                    „In angesehenen Schulen hat man beobachtet, dassKinder gerne und erfolgreich lernen, wenn sie sich auf dieErwachsenen verlassen können. Lernen brauchtverlässliche Beziehungen, die Halt geben. Diese wachsenüber Jahre und sind nicht von Beginn an vorhanden. Injahrelang erfahrenen und routinierten Klassen findet maneine inklusive, mehrperspektivische Lernkultur, die zuguten Lernergebnissen führt. Sie ist geprägt vonACHTUNG, VERTRAUEN, ZUGEHÖRIGKEIT UNDBEGLEITUNG. Hattie verwendet als Gütekriterien ähnlicheBegriffe: BEZIEHUNG, VERTRAUEN, ZUGEWANDTHEIT,SICHERHEIT UND ANSPRUCHSVOLLE LERNZIELE.“(S.97 Teambuch Inklusion - Praxisbuch fürmultiprofessionelle Teams)http://www.schule-im-aufbruch.dehttp://www.schulen-der-zukunft.orgwww.laenger-gemeinsam-lernen-bw.deTeambuch Inklusion - Praxisbuch für multiprofessionelleTeams, Reinhard Stähling Barbara Wenders
                    </p>
