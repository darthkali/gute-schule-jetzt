                ...
                <div className="innerBox ">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4  mt-4 py-0">
                        <div className={"col-span-3"}>
                            ...
                            <p>Wir wissen: Nur in einer gesunden Umgebung kann aufbauendes Lernen stattfinden und das
                                volle
                                Potenzial eines Menschen entfaltet werden.
                                Die Voraussetzung für aufbauendes Lernen ist die Beachtung der beiden Grundbedürfnisse
                                nach
                ...
                <div className={"innerBox"}>
                    ...
                    >
                        ...
                        <p>Schule, als stark machender Lebens-und Lernort, gibt Kindernund Jugendlichen das, was sie aus
                            entwicklungspsychologischerSicht brauchen, ermöglicht Lernen, wie es aus
                            neurobiologischerSicht
                            nachhaltig ist und bereitet Schülerinnen und Schüler auf einLeben in der Gesellschaft vor,
                            wie
                            diese sich heute zeigt und inZukunft abzeichnet.Die neurobiologischen Forschungen lassen die
                            Notwendigkeiterkennen, eine liebevolle Beziehungskultur zu entwickeln, in dervon Anfang an
                            das
                            Gefühl entsteht, angenommen zu sein, und inder die Menschen eingeladen sind, sich für die
                            Welt
                            zu öffnen.Wenn wir uns fragen, wie Lernen geschieht, müssen wir dasDogma aufgeben, das
                            Lernen
                            ...
                            Jugendliche im eigenen Lebensund Lernumfeld gesehen, zugehörig und verbundenfühlen2. dass
                            Kinder
                            ...
                            Möglichkeitenbekommen, ihr Gehirn auf komplexe Weise zu nutzen!Kinder brauchen echte
                            Aufgaben,
                            Anstrengung schadetihnen dabei nicht, aber sie brauchen den Erfolg und dieErfahrung der
                            Selbstwirksamkeit.Dann werden Kinder Konstrukteur ihres eigenen Bildungsprozessesund erleben
                            ein
                    ...
                    >
                        <p>
                            ...
                            bedeutet Vielfalt. IndividuellePersönlichkeitsentwicklung, Integration, Inklusion
                            undDemokratie
                            sind notwendige Grundlagen für einelebenstüchtige Gesellschaft. Das erfordert
                            eineTransformation
                            der Schulen vom Ort des Lehrens zumOrt des inklusiven und kooperativen Lernens.Dazu ist an
                            vorderster Stelle eine Haltung zu priorisieren:Grundlegende Bildung für alle Kinder zu
                            Werten
                            wie gelebterVielfalt, Mitgefühl und Toleranz!Dafür sind die Rahmenbedingungen zu schaffen:
                            So
                            ...
                            Menschliches Glück wird von unserenBeziehungen mit anderen angetrieben. Teamarbeit und
                            Raumfür
                        ...
                        zwischen denNervenzellen, also durch Verstärkung seiner Vernetzung.Dieses Wachstumsmodell
                        übertragen
                        auf menschlicheGemeinschaften oder Kommunen heißt: mehrBegegnung, mehr Austausch, mehr
                        Vernetzung,
                        mehrGemeinsinn, mehr Kreativität und mehrInnovationsgeist.Das Zeitalter der Einzelkämpfer, in
                        dem
                        ...
                        UN-Behindertenrechtskonvention fordert einestrukturelle Transformation des
                        deutschenBildungssystems
                        ...
                        „In angesehenen Schulen hat man beobachtet, dassKinder gerne und erfolgreich lernen, wenn sie
                        sich
                        auf dieErwachsenen verlassen können. Lernen brauchtverlässliche Beziehungen, die Halt geben.
                        Diese
                        wachsenüber Jahre und sind nicht von Beginn an vorhanden. Injahrelang erfahrenen und
                        routinierten
                        Klassen findet maneine inklusive, mehrperspektivische Lernkultur, die zuguten Lernergebnissen
                        führt.
                        Sie ist geprägt vonACHTUNG, VERTRAUEN, ZUGEHÖRIGKEIT UNDBEGLEITUNG. Hattie verwendet als
                        Gütekriterien ähnlicheBegriffe: BEZIEHUNG, VERTRAUEN, ZUGEWANDTHEIT,SICHERHEIT UND
                        ANSPRUCHSVOLLE
